...
class DataExportManager:
    ...
    def export_json(self, filename):
        ...
        data = {
            ...
            "values": self.parent.last_result.beta.tolist(),
            "errors": self.parent.last_result.sd_beta.tolist(),
    ...
    def export_csv(self, filename):
        ...
        param_values = self.parent.last_result.beta
        param_errors = self.parent.last_result.sd_beta
